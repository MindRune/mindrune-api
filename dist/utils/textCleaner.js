...
exports.debugText = exports.cleanNpcName = exports.cleanItemName = exports.cleanTargetText = void 0;
/**
...
exports.cleanTargetText = cleanTargetText;
/**
...
exports.cleanItemName = cleanItemName;
/**
...
exports.cleanNpcName = cleanNpcName;
// A debug utility function to log samples of text and characters
const debugText = (text, label = "Text") => {
    if (!text) {
...
exports.default = {
    cleanTargetText: exports.cleanTargetText,
    cleanItemName: exports.cleanItemName,
    cleanNpcName: exports.cleanNpcName,
    debugText: exports.debugText
};
